...
import { single } from '../map/data';

import { ScatterData, Service } from '../map/map.service';
...
@Component({
  selector: 'app-maparutas',
  templateUrl: './maparutas.component.html',
  styleUrls: ['./maparutas.component.css'],
  providers : [Service]
})
export class MaparutasComponent implements OnInit, AfterViewInit {
  ...
  tipoDoc = [
    ...
    {value: 'extranjeria', viewValue: 'Carnet de Extranjería'}
  ];
